...
int main()
{
    ...
    vector<vector<float>> Xapp = readMatFromFile("samples/Xapp.txt");
    vector<vector<float>> Ta = readMatFromFile("samples/TA.txt");
    vector<vector<float>> Xtest = readMatFromFile("samples/Xtest.txt");
    vector<vector<float>> Tt = readMatFromFile("samples/TT.txt");
